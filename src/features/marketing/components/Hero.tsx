            ...
            <div className="container mx-auto max-w-6xl">
                <div className="text-center space-y-8">
                    ...
                    <p className="text-xl sm:text-2xl text-foreground-600 max-w-3xl mx-auto">
                        Build a private daily system with guided onboarding,
                        goal-based habits, recovery prompts, and reminder-backed
                        check-ins. Habitly is designed to keep you consistent,
