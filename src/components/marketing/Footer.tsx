      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-foreground-600 text-sm">
              Build better habits, one day at a time. Transform your life
              through consistent daily actions.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="#features"
                  className="text-foreground-600 hover:text-primary transition-colors text-sm"
                >
                  Features
                </Link>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-divider flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://github.com/OleksandrPanichuk/Habitly"
              target="_blank"
              rel="noopener noreferrer"
              className="text-foreground-600 hover:text-primary transition-colors"
            >
              <span className="sr-only">View our GitHub repository</span>
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
